...
class SpGAT(nn.Module):
    def __init__(self, nfeat, nhid, out_features, dropout, alpha, nheads):
        ...
        self.out_att = SpGraphAttentionLayer(
            nhid * nheads, out_features, dropout=dropout, alpha=alpha, concat=False
        )
    ...
    def forward(self, x, adj):
        ...
        return torch.mean(x, dim=0)  # 平均池化
