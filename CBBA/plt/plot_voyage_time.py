...
def plot_from_file(file_path, save_dir):
    ...
    """
    # 方法名称（与数据顺序对应）
    methods = ["AUCTION", "CONTRACTNET", "CCBA", "CCBA_KMEANS", "CCBA_MY"]
    # 设置中文字体支持，选用更美观的字体
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(current_script_dir, "..", "outputs", "scatter_plot.pdf")
    plot_from_file("CBBA/plt/time_voyage.txt", save_dir)  # 假设文件与脚本在同一目录
